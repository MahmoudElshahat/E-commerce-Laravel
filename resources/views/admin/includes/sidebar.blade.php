           ...
           <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
               ...
               <li class="nav-item  open ">
                   ...
                   <ul class="menu-content">
                       ...
                       <li><a class="menu-item" href="{{route('lang.create')}}" data-i18n="nav.dash.crypto">أضافة
                               لغة جديده </a>{r
                       </li>
                   </ul>
               </li>
               ...
               <li class="nav-item"><a href="{{route('all.categori')}}"><i class="la la-group"></i>
                       ...
                       <span
                           class="badge badge badge-danger badge-pill float-right mr-2">{{App\Models\main_categori::count()}}</span>
                   </a>
                   <ul class="menu-content">
                       <li class="active"><a class="menu-item" href="{{route('all.categori')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                       </li>
                       <li><a class="menu-item" href="{{route('create.categori')}}" data-i18n="nav.dash.crypto">أضافة
                                قسم جديد </a>
                       </li>
                   </ul>
               </li>
