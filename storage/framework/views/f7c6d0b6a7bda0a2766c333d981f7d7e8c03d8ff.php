           ...
           <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
               ...
               <li class="nav-item  open ">
                   ...
                   <ul class="menu-content">
                       ...
                       <li><a class="menu-item" href="<?php echo e(route('lang.create')); ?>" data-i18n="nav.dash.crypto">أضافة
                               لغة جديده </a>{r
                       </li>
                   </ul>
               </li>
               ...
               <li class="nav-item"><a href=""><i class="la la-group"></i>
                   ...
                   <ul class="menu-content">
                       ...
                       <li><a class="menu-item" href="<?php echo e(route('create.item')); ?>" data-i18n="nav.dash.crypto">أضافة
                            منتج</a>
                       </li>
                   </ul>
               </li>
